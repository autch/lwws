...
public class CitiesTableHelper {
	...
	private static final String[] COLUMNS = { "_id", "city_id", "last_updated" };
	...
	public long insertCity(int city_id) {
		...
		values.put("last_updated", new Date(System.currentTimeMillis()).toString());
	...
	public Cursor queryAll() {
		return sqlite.rawQuery("SELECT c._id _id, area_id, pref_id, c.city_id, name, c.last_updated FROM cities c LEFT JOIN forecastmap f ON c.city_id = f.city_id", null);
	}
